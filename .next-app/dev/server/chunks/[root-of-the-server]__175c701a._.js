...
"[project]/src/app/api/vendor/products/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function isCreateProductBody(value) {
    if (typeof value !== "object" || value === null) return false;
    const data = value;
    return typeof data.name === "string" && data.name.trim().length > 0 && typeof data.price === "number" && Number.isFinite(data.price) && typeof data.stock === "number" && Number.isInteger(data.stock);
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__175c701a._.js.map