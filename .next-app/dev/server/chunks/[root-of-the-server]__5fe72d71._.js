...
"[project]/src/app/api/vendor/store/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function isCreateStoreBody(value) {
...
async function GET(request) {
    ...
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(store);
    } catch  {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function POST(request) {
    try {
        ...
        if (!isCreateStoreBody(body)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: "Invalid body. Required: name (string), lat (number), lng (number), optional description (string)"
            }, {
                status: 400
            });
        }
        // 4️⃣ Check if store already exists
        const existingStore = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].store.findUnique({
            where: {
                vendorId: auth.userId
            },
            select: {
        ...
        // 6️⃣ Create store
        const createdStore = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].store.create({
            data: {
                name: body.name.trim(),
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(createdStore, {
            status: 201
        });
    } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5fe72d71._.js.map