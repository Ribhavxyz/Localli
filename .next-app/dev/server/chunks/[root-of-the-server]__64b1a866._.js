...
async function POST(request) {
    ...
    try {
        ...
        const order = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction(async (tx)=>{
        ...
        for (const item of cartItems){
            void __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].interactionLog.create({
                data: {
                    userId: auth.userId,
                    productId: item.productId,
                    action: "PURCHASE"
        ...
        if (checkoutError instanceof Error && checkoutError.message === INSUFFICIENT_STOCK_ERROR) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__64b1a866._.js.map