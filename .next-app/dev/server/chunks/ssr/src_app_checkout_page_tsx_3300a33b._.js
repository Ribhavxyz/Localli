...
function CheckoutPage() {
    ...
    async function handlePlaceOrder() {
        try {
            setSubmitting(true);
            setError(null);
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$authFetch$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authFetch"])("/api/checkout", {
                method: "POST"
            });
            const data = await response.json();
            if (!response.ok) {
